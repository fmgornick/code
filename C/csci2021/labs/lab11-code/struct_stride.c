...
int main(int argc, char *argv[]){
  ...
  printf(FORMAT,"int_field_base",cpu_time,0);
  ...
  // TODO: COMPUTE CPU TIME AND PRINT IT using the provided FORMAT string
  cpu_time = ((double) end - begin) / CLOCKS_PER_SEC;
  printf(FORMAT,"arr_field_base",cpu_time,0);
  ...
  // TODO: COMPUTE CPU TIME AND PRINT IT using the provided FORMAT string
  cpu_time = ((double) end - begin) / CLOCKS_PER_SEC;
  printf(FORMAT,"int_field_optm",cpu_time,0);
  ...
  // TODO: COMPUTE CPU TIME AND PRINT IT using the provided FORMAT string
  cpu_time = ((double) end - begin) / CLOCKS_PER_SEC;
  printf(FORMAT,"arr_field_optm",cpu_time,0);
